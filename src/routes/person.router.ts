...
personRoutes.post("/pessoa", createPersonValidation ,new PersonController().create);
personRoutes.get("/pessoa", getAllPersonValidation ,new PersonController().get);
personRoutes.get("/pessoa/:id", getPersonByIdValidation ,new PersonController().getById);
personRoutes.delete("/pessoa/:id", getPersonByIdValidation, new PersonController().delete);
personRoutes.put("/pessoa/:id", getPersonByIdValidation, updatePersonValidation ,new PersonController().update);
